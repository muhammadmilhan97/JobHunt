          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                JobCard(
                  job: job,
                  onTap: null, // Disable tap since we're already on detail page
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _DetailRow(
                          ...
                          label: 'Location',
                          value: '${job.locationCity}, ${job.locationCountry}',
                        ),
                        _DetailRow(
                          icon: Icons.category,
                          label: 'Category',
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              FilledButton(
                onPressed: () => ref.invalidate(jobByIdProvider(widget.jobId)),
