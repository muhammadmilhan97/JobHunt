...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, Object? error) failure,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String message, Object? error)? failure,
...
class _$FailureImpl<T> extends Failure<T> {
  const _$FailureImpl(this.message, [this.error]) : super._();
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(message, error);
  }
...
abstract class Failure<T> extends Result<T> {
  const factory Failure(final String message, [final Object? error]) =
      _$FailureImpl<T>;
